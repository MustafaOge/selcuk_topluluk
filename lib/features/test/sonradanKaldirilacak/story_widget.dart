...
class StoryWidget2 extends StatefulWidget {
  const StoryWidget2({Key? key}) : super(key: key);

  @override
  State<StoryWidget2> createState() => _StoryWidget2State();
}
...
class _StoryWidget2State extends State<StoryWidget2> with TickerProviderStateMixin {
...
// the point of animation
  ...
  var modelTest = ["Selçuk Tıp", "Konferans", "Tıp Bayramı", "Teknofest", " Piknik", "Akademik"];
