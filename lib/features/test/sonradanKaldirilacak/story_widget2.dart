...
class StoryWidget3 extends StatefulWidget {
  const StoryWidget3({Key? key}) : super(key: key);

  @override
  State<StoryWidget3> createState() => _StoryWidget3State();
}
...
class _StoryWidget3State extends State<StoryWidget3> with TickerProviderStateMixin {
...
// the point of animation
  ...
  var modelTest = ["Selçuk Hukuk", "Konferans", "Baro Ziyareti", "Hukuk Yarışması", " Piknik", "Akademik"];
