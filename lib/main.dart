...
import 'features/register_page/forgot_password/forgot_password.dart';
...
import 'features/test/sonradanKaldirilacak/community_profile_1.dart';
import 'features/test/sonradanKaldirilacak/community_profile_2.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        ...
        routes: {
          ...
          "communityProfile1": (context) => CommunityProfile1(),
          "CommunityProfile2": (context) => CommunityProfile2(),
        },
        home: Scaffold(
